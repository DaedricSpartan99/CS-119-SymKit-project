...
public:
    ...
    //On utilise les constantes prises plus bas pour la construction de la particules
    //ceci pour alléger l'écriture dans betascene
    ...
    /* Pour cumuler une force de repulsion de la camera à la particule */
